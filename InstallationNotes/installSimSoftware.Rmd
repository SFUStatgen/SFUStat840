...
`conda-forge` website that hosts conda-installable packages. To get around this, I have built and 
uploaded our own conda-installable version of `pyslim`
to the class GitHub site. To simplify the installation 
of pyslim from with R, I've also written a function 
`conda_install_local()`. Both the package and R 
