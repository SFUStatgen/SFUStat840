...
On my Mac the paths are `/Users/jgraham/miniconda3/bin/python`  and
`/Users/jgraham/miniconda3/bin/conda`, but I think recent versions 
of the installer would use `/Users/jgraham/opt/miniconda3/bin/python` 
and `/Users/jgraham/opt/miniconda3/bin/conda`, with an `opt` between 
the user name and `miniconda3`.
...
```
envname <- "Stat840"
conda <- "~/miniconda3/bin/conda" # change this if necessary
...
**NOTE: THESE INSTRUCTIONS HAVE NOT BEEN TESTED WITH THE MOST RECENT VERSIONS OF THE SOFTWARE. IF YOU CAN'T GET THINGS WORKING, PLEASE SKIP TO THE NEXT SECTION**
